...
test('fails to create an asset type if missing or invalid parameters', async (t) => {
  ...
  t.true(error.message.includes('"pricing" must be an object'))
  t.true(error.message.includes('"timing" must be an object'))
  t.true(error.message.includes('"unavailableWhen" must be an array'))
  t.true(error.message.includes('"transactionProcess" must be an object'))
  t.true(error.message.includes('"namespaces" must be an object'))
